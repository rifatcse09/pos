...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapActions)(["getOrderList", "setStatus"])), {}, {
    getOrders: function getOrders() {
      this.$store.dispatch('getOrderList');
    },
    onDetailsClick: function onDetailsClick(id) {
      var url = "".concat(this.$route.path, "/details/").concat(id);
      this.$router.push(url);
    },
    onSwitchClick: function onSwitchClick(invoice, amount) {
      this.$store.dispatch('setStatus', {
        invoice: invoice,
        amount: amount
      });
      $("#taxlist").DataTable().clear().destroy();
      this.getOrders();
      $('#dataTable').DataTable();
    }
  })
...
var render = function render() {
  ...
  return _c("div", [_vm._m(0), _vm._v(" "), _c("div", {
    ...
    staticClass: "text-nowrap table-right-sticky-col text-center"
  }, [_vm._v("Action")])], 2)]), _vm._v(" "), _c("tbody", _vm._l(_vm.orders.data, function (item, index) {
    return _c("tr", {
      key: index
      ...
      staticClass: "table-right-sticky-col"
    }, [_c("div", {
      staticClass: "inner-sticky"
    }, [(item["payment_status"] == "PAID" ? false : true) ? _c("button", {
      ...
      on: {
        click: function click($event) {
          ...
          return _vm.onSwitchClick(item.invoice_id, item.amount);
        }
      }
    }, [_vm._v("\n                             \n                               Switch\n                              ")]) : _vm._e(), _vm._v(" "), _c("button", {
      staticClass: "btn btn-info btn-user btn-block",
      attrs: {
        type: "button"
      },
      on: {
        click: function click($event) {
          $event.preventDefault();
          return _vm.onDetailsClick(item.id);
        }
      }
    }, [_vm._v("\n                               Details\n                              ")])])])], 2);
  }), 0)])])])])]);
